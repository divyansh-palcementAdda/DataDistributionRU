...
const fetchLeadsForCard = async (activeFilters, boardId, page, size, sortBy, sortDirection, filterRequest) => {
...
const BoardDetails = () => {
    ...
    const downloadExcel = async () => {
        try {
            ...
            const filename = `board_leads_${timestamp}.xlsx`;
        ...
        <div className="block p-4 sm:p-6" id="page-board-detail">
            ...
            <div className="flex flex-wrap items-start justify-between gap-3 mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-gray-900 leading-tight">Specialization</h1>
                        <p className="text-sm text-gray-500 mt-1">View comprehensive details for this board</p>
                    </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm mb-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-start gap-5 mb-8 pb-6 border-b border-gray-100">
                        <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center text-white text-2xl font-bold shadow-md flex-shrink-0">
                            {details?.name ? details.name.substring(0, 2).toUpperCase() : 'BD'}
                        </div>
                        <div className="flex-1">
                            ...
                            <div className="flex flex-wrap gap-2 items-center">
                                <span className={`text-[10px] font-bold px-2.5 py-1 rounded-full border uppercase tracking-wide ${
                                    details?.active === true || details?.status === 'ACTIVE'
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                            <div className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">Board Code</div>
