...
const Sidebar = () => {
  ...
  const navItems = [
   ...
   { id: 'followup-form',
    ...
    { id: 'consultancy', label: 'Consultancy', icon: '<svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M3 21h18M5 21V7l8-4 8 4v14M8 21v-9a2 2 0 012-2h4a2 2 0 012 2v9"/></svg>' },
